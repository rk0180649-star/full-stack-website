...
// Step A: Email check karein aur OTP send karein
exports.sendOtp = async (req, res) => {
  try {
    ...
    // Pehle ka koi purana OTP ho toh clear karein
...
// Step B: OTP verify karein aur User register karein
